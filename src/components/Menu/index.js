...
import { MenuItem, TlItem, EmpItem, MobileMenu } from "./constant";
const { SubMenu } = Menu;
class MenuComponent extends Component {
  ...
  setOpenKeys = (e) => {
    try {
      ...
      else if (e.key === "Change Password") this.props.history.push("/change-password");
      else {
